$(function () {
    ...
    function updateStepButtons() {
        $groups.each(function (index) {
            ...
            var $secondary = $btnArea.find('.btn-secondary').last();
            ...
            $primary
                ...
                .text(step === GROUP_MAX ? '법인 공동인증서 인증하기' : '다음');
    ...
    // step 화면 전환: step4는 마지막 단계이자 미리보기 단계
    ...
    // 다음 버튼: step1 > step2 > step3 > step4(미리보기)
    ...
    // include 완료 후 버튼 역할/중복 id/카드 높이 다시 계산
    $(document).on('include:loaded', '.page-container .group', function () {
        syncDuplicateIds();
        updateStepButtons();
        syncLayoutCards();
