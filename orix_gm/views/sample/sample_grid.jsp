...
<body>
    <div class="wrap">
        ...
        <nav class="side-nav">
            <div class="logo">
                <a href="#none">
                    <img src="../../resource/images/com/svg/orix_logo.svg" alt="ORIX로고" />
                </a>
            </div>
            <ul class="side-menu">
                <li>
                    <a href="#none" title="공매입찰관리" class="on">
                        <img src="../../resource/images/com/svg/btn_bid_manage.svg" alt="공매입찰관리" />
                    </a>
                </li>
                <li>
                    <a href="#none" title="사용자관리">
                        <img src="../../resource/images/com/svg/btn_user_manage.svg" alt="사용자관리" />
                    </a>
                </li>
            </ul>
        </nav>
                    ...
                    <div class="grid-body">
                        <div class="grid-caption">
                            <div class="caption-left">
                                <input type="text" class="tag-end" id="bidStatNm" name="BID_STAT_NM" value="" readonly />
    ...
    <script>
        ...
        function setBidStatus(item) {
            ...
            } else if (statusText === '입찰 시간 종료') {
                $bidStatNm.addClass('tag-end');
            } else if (item.BID_STAT === 'AU110009') {
        ...
        function createGrid() {
            ...
            grid = new tui.Grid({
                ...
                columns: [
                    ...
                    { header: '이전일자', name: 'OWNER_CHANGE_DATE', width: 100, sortable: true },
